		  ...
		  >
			...
			<StyledMenuItem>
			  <ListItemIcon>
				...
				<NavLink exact activeClassName='Navbar-active' to='/Chart1' onClick={()=>{changeTitle("Chart1")}}>
				  Chart1
				</NavLink>
			</StyledMenuItem>
			...
			<StyledMenuItem>
			  <ListItemIcon>
				...
				<NavLink exact activeClassName='Navbar-active' to='/Chart2' onClick={()=>{changeTitle("Chart2")}}>
				  Chart2
				</NavLink>
			</StyledMenuItem>
			...
			<StyledMenuItem>
			  <ListItemIcon>
				...
				<NavLink exact activeClassName='Navbar-active' to='/Chart3' onClick={()=>{changeTitle("Chart3")}}>
				  Chart3
				</NavLink>
			</StyledMenuItem>
			...
			<StyledMenuItem>
			  <ListItemIcon>
				...
				<NavLink exact activeClassName='Navbar-active' to='/Chart4' onClick={()=>{changeTitle("Chart4")}}>
				  Chart4
				</NavLink>
			</StyledMenuItem>
